...
const Admin = () => {
    ...
    const newItem: ItemsType = {
        ...
        size: 0,
        type: "Не указан",
        url: "https://fractus.com.ua/wp-content/uploads/2018/06/belyj_tovar.jpg"
    }
    ...
    return (
        <div className={styles.admin}>
            ...
            >
                Заполнить store товарами из JSON
            </button>
            ...
            <button className={`${styles.btn__open} ${(form ? styles.open : styles.close)}`}
                ...
                {!form ? "Открыть форму" : "Закрыть форму"}
            </button>
            {form &&
                <div>
                    <form>
